...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-r from-cyan-100 via-blue-100 to-blue-200/80 backdrop-blur shadow-inner py-6 px-6 flex flex-col md:flex-row items-center justify-between border-t-2 border-blue-300">
